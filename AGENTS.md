...
A collection of skills for Claude.ai and Claude Code for working as Imre Nagi. Skills are packaged instructions and scripts that extend Claude's capabilities.
...
- **Skill directory**: `kebab-case` (e.g., `go-programmer`, `log-monitor`)
